 ...
 * slightly modified from Guava's UnsignedBytes class to be able to compare
 * arrays that start at non-zero offsets.
 */
@SuppressWarnings("restriction")
public abstract class FastByteComparator {
    ...
    public static int compareTo(byte[] b1, int s1, int l1, byte[] b2, int s2, int l2) {
        return LexicographicalComparatorHolder.BEST_COMPARATOR.compareTo(
                b1, s1, l1, b2, s2, l2);
    }
